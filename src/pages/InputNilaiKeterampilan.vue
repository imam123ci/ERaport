   ...
   <v-card 
    ...
    >
        <v-card-title class="pa-4">
            <h2>Input Nilai Keterampilan</h2>
        </v-card-title>
    ...
    data: () => ({
     ...
     methods: {
        ...
        createNilaiPengetahuan(){
            ...
            let pelajaran = this.UI.SelectedPelajaran;
            let agama = ['Budha', 'Islam', 'Protestan', 'Katholik', 'Hindu', 'Konghucu'];
            this.SiswaDB.find(
