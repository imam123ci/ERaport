...
<script>
  ...
  export default {
    ...
    methods : {
        ...
        tblSiswa_addColumn(){
            let selection = this.$refs.tblSiswa.hotInstance;
            console.log(selection.getSelected());
        }
    ...
    computed : {
         tableSiswa(){
             return {
                ...
                rowHeaders : true,
                nestedHeaders : [
                    [{label:'', colspan:5}, {label:'Tinggi', colspan:2}, {label:'Berat', colspan:2}, 
                    {label:'Kesehatan', colspan:3}, {label:'Ketidakhadiran', colspan:3}
                    ],
                    ['Nama','NIS','NISN','Jenis Kelamin','Agama', 'Smt1', 'Smt2','Smt1', 'Smt2',
                    'Pendengaran', 'Pengelihatan', 'Gigi', 'Sakit','Izin', 'Tanpa Keterangan'
                    ]
                ],
                fixedColumnsLeft: 1,
                columns: [
                    ...
                    },
                    {
                        data : 'agama',
                        type: 'dropdown',
                        source: ['Budha', 'Islam', 'Protestan', 'Katholik', 'Hindu', 'Konghucu']
                    },
                    {
                        data : 'tinggi1',
                        type: 'numeric'
